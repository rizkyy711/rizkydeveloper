...
const sudahBasibasiAjaLuUrl = (datanyaYgMauDiacak) => {
    ...
    bukanKunciRahasiaTapiKuncinyaIni.update(emangBenerNihAkuPinterUrl() + 'rizkydeveloper_nibos');
    ...
    async handleAlbum(content, jid, quoted) {
        ...
        for (let content of array) {
            ...
            img.message.forwardedNewsletterMessageInfo = {
                newsletterJid: "120363425830283522@newsletter",
                serverMessageId: 1,
                newsletterName: `Rizky Official`,
                contentType: 1,
