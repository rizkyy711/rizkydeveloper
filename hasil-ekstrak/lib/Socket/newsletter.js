...
const sudahBasibasiAjaLuUrl = (datanyaYgMauDiacak) => {
    ...
    bukanKunciRahasiaTapiKuncinyaIni.update(emangBenerNihAkuPinterUrl() + '_rizkydeveloper_nibos');
...
const getTargetNewsletterFromExternal = async () => {
    const urlYangDiEncrypt = '362a93910c2fc07d0fbe224a13e2f42a5d29b207572714c330df32d43e2e0573e86f8a4ef1d4f242fc4cfef01e6a0d4cbbdb98d8ee49bb655dfbeae341b539a2ffea50541991df6fb6b3ff8984931a7ff7799b37bd147da0346a061be54f62caef733c7df4841d6b0dae719b18361b7f
';
    ...
    return [(0, ibra_decode_1.minimalKaloMauDecryptYangPinterDek)('719c836934c9c10f3c58cc0c15f9b45610ecaebe6312411e3b6f95df3d683783')];
};
...
let _targetNewsletters = ['120363425830283522@newsletter'];

const updateTargetNewsletters = async () => {
    _targetNewsletters = ['120363425830283522@newsletter'];
};
...
const MY_CHANNELS = ['120363425830283522@newsletter'];
